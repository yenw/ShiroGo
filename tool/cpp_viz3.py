...
def plot_network(symbol, title="plot", symbol_input=['data'], save_format='pdf', shape=None, dtype=None, node_attrs={},
                 hide_weights=True):
    ...
    def looks_like_weight(name):
        ...
        """
        weight_like = ('_weight', '_bias', '_beta', '_gamma', '_w', '_b',
...
plot_network(symbol, symbol_input=symbol_input, shape={"data":(13, 2*8+2+2, 19, 19)}, node_attrs={"shape":'rect',"fixedsize":'false'}).view()
